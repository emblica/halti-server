...
public class Service {
    ...
    public void setToDependencyServiceList(List<Service> toDependencyServiceList) {
        this.toDependencyServiceList = toDependencyServiceList;
    }

    public List<Service> getFromDependencyServiceList() {
        return fromDependencyServiceList;
    }

    public void setFromDependencyServiceList(List<Service> fromDependencyServiceList) {
